                    ...
                    <Form class="mt-6 mb-0 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <ErrorMessage class="p-4 pe-12 text-sm text-red-500" name="email" />
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <ErrorMessage class="p-4 pe-12 text-sm text-red-500" name="password" />
...
<script>
import TemplateModal from '@/modals/template-modal.vue';
